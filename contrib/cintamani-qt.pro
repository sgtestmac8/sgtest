...
SOURCES += src/activemasternode.cpp \
           ...
           src/darksend.cpp \
           src/cintamani-cli.cpp \
           src/cintamani-tx.cpp \
           src/cintamanid.cpp \
           src/db.cpp \
           ...
           src/qt/cintamani.cpp \
           src/qt/cintamanistrings.cpp \
...
RESOURCES += src/qt/cintamani.qrc src/qt/cintamani_locale.qrc
TRANSLATIONS += src/qt/locale/cintamani_bg.ts \
                src/qt/locale/cintamani_de.ts \
                src/qt/locale/cintamani_en.ts \
                src/qt/locale/cintamani_es.ts \
                src/qt/locale/cintamani_fi.ts \
                src/qt/locale/cintamani_fr.ts \
                src/qt/locale/cintamani_it.ts \
                src/qt/locale/cintamani_ja.ts \
                src/qt/locale/cintamani_pl.ts \
                src/qt/locale/cintamani_pt.ts \
                src/qt/locale/cintamani_ru.ts \
                src/qt/locale/cintamani_sk.ts \
                src/qt/locale/cintamani_sv.ts \
                src/qt/locale/cintamani_vi.ts \
                src/qt/locale/cintamani_zh_CN.ts \
                src/qt/locale/cintamani_zh_TW.ts
