...
However, in open source software such as Cintamani Core, where everyone uses
...
pay attention to for reviewers of Cintamani Core code.

General Cintamani Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Cintamani Core uses tinyformat, which is type safe. Leave them out to avoid confusion
