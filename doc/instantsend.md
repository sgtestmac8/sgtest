...
This mechanism has been integrated into Bitcore-Node-Cintamani which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cintatest/insight-api-cintamani#web-socket-api](https://github.com/cintatest/insight-api-cintamani#web-socket-api) 
* API: [https://github.com/cintatest/insight-api-cintamani#instantsend-transactions](https://github.com/cintatest/insight-api-cintamani#instantsend-transactions) 
...
By default, the Cintamani Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Cintamani Core daemon:
