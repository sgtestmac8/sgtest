...
Only requiring some minor changes is cintamani.cpp.
...
Changes to cintamani.cpp
----------------------
cintamani.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
