...
Cintamani Core version 0.12.0 is now available from:

  https://cintatest.io/downloads

Please report bugs using the issue tracker at github:

  https://github.com/cintatest/cintamani/issues
...
backwards-compatible with pre-0.12 versions of Cintamani Core or other software:
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/cintamani/).
