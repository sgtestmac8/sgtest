...
This document provides guidelines for internationalization of the Cintamani Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to Cintamani network</numerusform>
            <numerusform>%n active connections to Cintamani network</numerusform>
        </translation>
    </message>
