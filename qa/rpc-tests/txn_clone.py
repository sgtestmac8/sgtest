...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 CINTAMANI:
        ...
        # 400 CINTAMANI serialized is 00902f5009000000
        pos0 = 2*(4+1+36+1+4+1)
        ...
        # Node0's balance should be starting balance, plus 500CINTAMANI for another
        ...
        # Check node0's total balance; should be same as before the clone, + 1000 CINTAMANI for 2 matured,
