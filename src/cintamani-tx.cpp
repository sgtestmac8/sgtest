...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Cintamani Core cintamani-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cintamani-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cintamani transaction") + "\n" +
              "  cintamani-tx [options] -create [commands]   " + _("Create hex-encoded cintamani transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cintamani transaction
