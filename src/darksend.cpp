...
/* *** BEGIN DARKSEND MAGIC - CINTAMANI **********
    Copyright (c) 2014-2015, Cintamani Developers
        eduffield - evan@cintatest.io
        udjinm6   - udjinm6@cintatest.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Cintamani and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("cintamani-darksend");
