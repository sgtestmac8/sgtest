...
#if defined(NDEBUG)
# error "Cintamani cannot be compiled without assertions."
#endif
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue)
{
    ...
    if(Params().NetworkID() == CBaseChainParams::TESTNET) {
        if(nHeight > 46000)             ret += blockValue / 20; //25% - 2018-10-07
        if(nHeight > 46000+((576*1)*1)) ret += blockValue / 20; //30% - 2018-10-08
        if(nHeight > 46000+((576*1)*2)) ret += blockValue / 20; //35% - 2018-10-09
        if(nHeight > 46000+((576*1)*3)) ret += blockValue / 20; //40% - 2018-10-10
        if(nHeight > 46000+((576*1)*4)) ret += blockValue / 20; //45% - 2018-10-11
        if(nHeight > 46000+((576*1)*5)) ret += blockValue / 20; //50% - 2018-10-12
        if(nHeight > 46000+((576*1)*6)) ret += blockValue / 20; //55% - 2018-10-13
        if(nHeight > 46000+((576*1)*7)) ret += blockValue / 20; //60% - 2018-10-14
    }

    if(nHeight > 158000)               ret += blockValue / 20; // 158000 - 25.0% - 2018-10-24
    if(nHeight > 158000+((576*30)* 1)) ret += blockValue / 20; // 175280 - 30.0% - 2018-11-25
    if(nHeight > 158000+((576*30)* 2)) ret += blockValue / 20; // 192560 - 35.0% - 2018-12-26
    if(nHeight > 158000+((576*30)* 3)) ret += blockValue / 40; // 209840 - 37.5% - 2019-01-26
    if(nHeight > 158000+((576*30)* 4)) ret += blockValue / 40; // 227120 - 40.0% - 2019-02-27
    if(nHeight > 158000+((576*30)* 5)) ret += blockValue / 40; // 244400 - 42.5% - 2019-03-30
    if(nHeight > 158000+((576*30)* 6)) ret += blockValue / 40; // 261680 - 45.0% - 2019-05-01
    if(nHeight > 158000+((576*30)* 7)) ret += blockValue / 40; // 278960 - 47.5% - 2019-06-01
    if(nHeight > 158000+((576*30)* 9)) ret += blockValue / 40; // 313520 - 50.0% - 2019-08-03

    /* 
        Hard for will activate on block 348080 separating the two networks (v11 and earier and v12)

        if(nHeight > 158000+((576*30)*11)) ret += blockValue / 40; // 348080 - 52.5% - 2019-10-05
        if(nHeight > 158000+((576*30)*13)) ret += blockValue / 40; // 382640 - 55.0% - 2019-12-07
        if(nHeight > 158000+((576*30)*15)) ret += blockValue / 40; // 417200 - 57.5% - 2020-02-08
        if(nHeight > 158000+((576*30)*17)) ret += blockValue / 40; // 451760 - 60.0% - 2020-04-11
    */
...
void ThreadScriptCheck() {
    RenameThread("cintamani-scriptch");
