...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::CINTAMANI);
    ...
    if (settings.contains("nAnonymizeDarkcoinAmount"))
        SoftSetArg("-anonymizecintamaniamount", settings.value("nAnonymizeDarkcoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in cintamani.cpp during shotdown to also remove the window positions
